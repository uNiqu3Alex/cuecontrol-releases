...
Ogni tavolo della sala e visibile a colpo d'occhio con il suo stato attuale: libero, occupato, in attesa. Apri una sessione con un tap, il timer parte e le luci del tavolo si accendono automaticamente. Quando il giocatore finisce, chiudi la sessione: il sistema calcola il costo, spegne le luci e registra tutto.
...
Configura tariffe orarie diverse per fascia oraria, tipo di tavolo o giorno della settimana. Il sistema applica automaticamente la tariffa corretta e calcola il costo al centesimo.

### Anagrafica giocatori

Tieni traccia dei tuoi clienti abituali: storico partite, crediti, abbonamenti e debiti. Ogni giocatore ha la sua scheda con tutti i dati sempre a portata di mano.
...
Registra le consumazioni al bar direttamente dalla sessione del tavolo. Il costo viene aggiunto automaticamente al conto del giocatore.

### Accesso remoto

Controlla la tua sala anche quando non sei fisicamente presente. L'app mobile ti permette di monitorare lo stato dei tavoli, consultare i report e verificare gli incassi da qualsiasi luogo.

### Ruoli e permessi

Definisci chi puo fare cosa. L'operatore alla cassa ha i suoi permessi, il titolare i suoi. Ogni azione sensibile e protetta e tracciata.
...
Gli aggiornamenti vengono scaricati e installati automaticamente quando disponibili, senza interrompere il lavoro.
...
- **Hardware luci**: Modulo rele compatibile sulla rete locale della sala
- **Connessione Internet**: Opzionale - necessaria solo per aggiornamenti automatici e accesso remoto
...
Per assistenza, segnalazione bug o richieste di nuove funzionalita:

- Apri una [Issue](https://github.com/uNiqu3Alex/tableflow-release/issues) su questo repository
